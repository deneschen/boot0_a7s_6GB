...
#define PPU_WRAP(n)						(0x07060000 + (n) * 0x1000)
...
#define SUNXI_INITARCH_REG(n)			(SUNXI_CLUS_OPS_BASE + 0x1000)
#define AARCH64							BIT(0)
#define SUNXI_CPUCFG_RVBAR_LO_REG(n)	(SUNXI_CLUS_OPS_BASE + 0x1000 + 0x4)
#define SUNXI_CPUCFG_RVBAR_HI_REG(n)	(SUNXI_CLUS_OPS_BASE + 0x1000 + 0x8)
