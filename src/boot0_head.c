...
const boot0_file_head_t  BT0_head = {
...

	{
		...
		0,
			...
			{
			{2, 9, 2, 1, 0xff, 0xff, {0} },/* PB9: UART0 TX, func2 */
			{2, 10, 2, 1, 0xff, 0xff, {0} },/* PB10: UART0 RX, func2 */
			},
		/*__s32 enable_jtag;*/
		0,
		...
		{
			{6, 2, 2, 1, 1, 0xff, {0} },/* PF2: SDC0 CLK */
			{6, 3, 2, 1, 1, 0xff, {0} },/* PF3: SDC0 CMD */
			{6, 1, 2, 1, 1, 0xff, {0} },/* PF1: SDC0 D0 */
			{6, 0, 2, 1, 1, 0xff, {0} },/* PF0: SDC0 D1 */
			{6, 5, 2, 1, 1, 0xff, {0} },/* PF5: SDC0 D2 */
			{6, 4, 2, 1, 1, 0xff, {0} },/* PF4: SDC0 D3 */
		},
	...
	/* AXP8191 is connected to TWI6 on PL0/PL1.  reserved[0] selects TWI6. */
	{
		{12, 0, 2, 1, 0xff, 0xff, {6, 0} },
		{12, 1, 2, 1, 0xff, 0xff, {6, 0} },
	},
